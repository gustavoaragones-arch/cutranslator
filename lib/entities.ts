...
> = {
  ...
  afghanistan: { id: "afghanistan", formalName: "Islamic Emirate of Afghanistan", shortName: "Afghanistan" },
  ...
  chad: { id: "chad", formalName: "Republic of Chad", shortName: "Chad" },
  burkina_faso: { id: "burkina_faso", formalName: "Burkina Faso", shortName: "Burkina Faso" },
  ...
  angola: { id: "angola", formalName: "Republic of Angola", shortName: "Angola" },
  botswana: { id: "botswana", formalName: "Republic of Botswana", shortName: "Botswana" },
  mozambique: { id: "mozambique", formalName: "Republic of Mozambique", shortName: "Mozambique" },
  sudan: { id: "sudan", formalName: "Republic of the Sudan", shortName: "Sudan" },
  cote_divoire: { id: "cote_divoire", formalName: "Republic of Côte d'Ivoire", shortName: "Côte d'Ivoire" },
  cameroon: { id: "cameroon", formalName: "Republic of Cameroon", shortName: "Cameroon" },
  drc: { id: "drc", formalName: "Democratic Republic of the Congo", shortName: "DR Congo" },

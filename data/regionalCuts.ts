...
export const regionalCuts: readonly RegionalCut[] = [
...

  {
    ...
    description: "India's beef ontology cannot be understood without the Cow vs Buffalo legal-cultural axis — the most consequential cultural marker in any country in the Cutranslator database. Under Article 48 of the Indian Constitution and various state laws, COW slaughter is legally restricted in 21 of 28 Indian states. In those states, 'Beef' refers exclusively to Water Buffalo (Bos bubalis), known regionally as 'Bada' (Hindi/Urdu), 'Bade ka Maans,' 'Bade ka Gosht,' or 'Buff.' The cow (Bos taurus) is a sacred animal in Hindu tradition, and asking for 'cow meat' in restricted states can cause genuine cultural offense — a tourist or expat unaware of this distinction risks both legal and social consequences. After Batch 18, the Indian Cow-Legal Map covers 11 regions — forming a 'South + Northeast Arc' pattern: SOUTH (3 isolated regions): Kerala, Goa (consumer-permissive), West Bengal. NORTHEAST (8 clustered regions): Meghalaya, Nagaland, Manipur, Mizoram, Arunachal Pradesh, Tripura, Assam, Sikkim. This re-positions the cow-legal map from 'scattered exceptions' (3 isolated regions as of Batch 17) to 'South + Northeast Arc' (11 regions clustered at the geographic periphery). All 8 Northeast states are cow-permissive — they form a contiguous cow-legal cluster, documented in `meghalaya_beef_paradise_in` (Batch 18). In Maharashtra, Telangana, Tamil Nadu, Karnataka, UP, Bihar, MP, Gujarat, Punjab, Haryana, Rajasthan, Chhattisgarh, Jharkhand, Odisha, J&K (varies by region), Himachal Pradesh, and Uttarakhand — the meat sold as 'beef' is ALWAYS Water Buffalo. Buffalo is leaner, darker, more fibrous, and significantly tougher than USDA cow beef. It requires 30-40% longer cooking, mandatory pressure-cooking or extensive marination (often with raw papaya or yogurt), and almost universally needs separately-purchased Charbi (fat) added for richness. An American expat using USDA recipes with Indian Buffalo without these adaptations produces 'rubbery' or 'livery' results that locals recognize as failed cooking. This entity is the architectural anchor for every Indian regional name with species: 'buffalo' — cross-referenced from every Buffalo-state Tier 3 entry.",
    notes: "PAN-INDIAN ANCHOR — UPDATED in Batch 18 to expand the cow-legal map from 3 to 11 regions (South + Northeast Arc). The single most important Tier 3 entry in the Indian dataset. Cross-reference from every Indian state's regional entries. Documents both the legal axis and the cooking-adaptation requirement. Cross-references `meghalaya_beef_paradise_in` (Batch 18, the NE cow-legal cluster anchor) and `smoked_beef_northeast_axis_in` (Batch 18, the 8-state NE smoked-beef axis).",
  },
...

  {
    ...
    notes: "Cross-references the forthcoming Ladakh Sha-skam (Batch 19) as the structural parallel — same air-drying preservation, different language, same cooking-ingredient distinction from US-style jerky. After Batch 19 deploys, this entity will be updated to formally cross-reference `ladakh_sha_skam_in` or equivalent slug. Cross-references `smoked_beef_northeast_axis_in` for the smoked variant of Sukuti (when Sukuti is hearth-smoked in addition to air-drying).",
  },
